...
def log_message(content: str, l_type: str, bg_col: str) -> None:
...
def custom_log(message: str, header: str, colour: Ansi) -> None:
    """Prints custom log with custom header and colour"""
    log_message(message, header, f"\033[{colour}m")


def debug(message: str) -> None:
    if DEBUG:
        log_message(message, "DEBUG", "\033[43m")


def info(message: str) -> None:
    log_message(message, "INFO", "\033[42m")


def error(message: str) -> None:
    log_message(message, "ERROR", "\033[41m")


def warning(message: str) -> None:
    log_message(message, "WARNING", "\033[44m")
